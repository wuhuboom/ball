...
import com.oxo.ball.service.pay.IPlayerPayServiceWOW;
...
@Service
public class PlayerPayServiceImplWOW implements IPlayerPayServiceWOW {
    ...
    public String requestPayUrl(BallPaymentManagement paymentManagement, PayRequestDtoCHA payRequest) {
        apiLog.info("WOW请求支付订单：{}",payRequest);
        ...
        try {
            ...
            if(PayCallBackDtoCHA.CHA_SUCCESS.equals(payCallBackDto.getRespCode())){
                apiLog.info("WOW请求支付成功:{}",payCallBackDto.getPayInfo());
