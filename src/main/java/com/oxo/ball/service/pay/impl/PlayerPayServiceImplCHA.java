...
import com.oxo.ball.service.pay.IPlayerPayServiceCHA;
...
@Service
public class PlayerPayServiceImplCHA implements IPlayerPayServiceCHA {
    ...
    public String requestPayUrl(BallPaymentManagement paymentManagement, PayRequestDtoCHA payRequest) {
        apiLog.info("CHA请求支付订单：{}",payRequest);
        ...
        try {
            ...
            data.add("payer_phone",payRequest.getPhone());
            ...
            if(PayCallBackDtoCHA.CHA_SUCCESS.equals(payCallBackDto.getRespCode())){
                apiLog.info("CHA请求支付成功:{}",payCallBackDto.getPayInfo());
